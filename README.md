...
AI-powered real-time fire and smoke detection system using YOLO and Computer Vision.
...
A 2-tier intelligent cattle identification system using Deep Learning and Transfer Learning.

### Features

* Cow vs Buffalo detection using YOLO
...
Machine Learning-based healthcare prediction system for heart disease analysis.
...
> Building intelligent systems that solve real-world problems using AI and software engineering.
